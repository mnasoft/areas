...
(defun hydraulic-diameter-rect (a b)
  "Гидравлический диаметр для прямоугольника."
  (areas:hydraulic-diameter (* a b) (+ a a b b)))

(defun hydraulic-diameter-trap (a b h)
  "Гидравлический диаметр для трапеции. Это весьма приблизительно."
           (areas:hydraulic-diameter (* (+ a b) 1/2 h) (+ a b h h)))
